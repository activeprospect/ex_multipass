defmodule MultipassExTest do
  ...
  test "Decodes a ruby sso generated multipass" do
    ...
    decode = MultipassEx.genDecode(product_code,"b825369ddd76f42ed8a65e86de793e5be46fed39ee82be9dbefc141f01515d89311267b7d2085f48d3236de7a81fca97ae1669d2d08a3f6f9193edbfa5113117")
  ...
  test "can encode and decode a multipass map" do
    ...
    encode = MultipassEx.genEncode(product_code, secret)
    decode = MultipassEx.genDecode(product_code, secret)
