defmodule ExMultipass.RailsParityTest do
  @moduledoc false
  use ExUnit.Case

  import ExMultipass.TestFixtures
  ...
  test "decode/3 returns the expected map when decoding a string from the Ruby Multipass gem" do
    ...
    {:ok, multipass_ex_decode} = ExMultipass.decode(rails_encrypted_string(), site_key, api_key)
